...
export const visualIdentity = {
  ...
  palette: [
    // GDS26R Brand Palette — supersedes prior product UI palette (Acid Lime / Off-Black)
    { name: 'Navy',         hex: '#111620', role: 'Page backgrounds, app shell, cards',     token: 'bg',       confirmed: true },
    { name: 'Bronze',       hex: '#C48A3A', role: 'Brand accent: headlines, logos, CTAs',   token: 'accent',   confirmed: true },
    { name: 'Warm Cream',   hex: '#F0EBE3', role: 'Primary text, headlines, light surfaces', token: 'text',    confirmed: true },
    { name: 'Focus Blue',   hex: '#7CBBDF', role: 'Interactive states: focus rings, links, data viz', token: 'focus', confirmed: true },
    { name: 'Surface 1',    hex: '#181E2A', role: 'Raised surfaces',     token: 'surface1', confirmed: true },
    { name: 'Surface 2',    hex: '#1F2735', role: 'Overlays',            token: 'surface2', confirmed: true },
    { name: 'Border',       hex: '#2E3849', role: 'Dividers',            token: 'border',   confirmed: true },
    { name: 'Sub Text',     hex: '#A8A29E', role: 'Subtitles',           token: 'textSecond',  confirmed: true },
    { name: 'Muted',        hex: '#78716C', role: 'Labels / metadata',   token: 'textMuted',   confirmed: true },
    { name: 'Success',      hex: '#8BAF9C', role: 'Confirmations, positive metrics',  token: 'success', confirmed: true },
    { name: 'Warning',      hex: '#D4A24B', role: 'Warning / unconfirmed',            token: 'warning', confirmed: true },
    { name: 'Error',        hex: '#C27A6B', role: 'Error / destructive',               token: 'error',   confirmed: true },
    { name: 'Info',         hex: '#8BA4BE', role: 'Info / neutral',                    token: 'info',    confirmed: true },
  ],
...
export const verbalIdentity = {
  ...
  voiceSpectrum: [
    { dim: 'Artist-to-Artist',   pct: 90, note: 'We speak like artists, not corporations' },
    ...
    { dim: 'Warm vs Cold',        pct: 65, note: 'Warm, but not sentimental. Confident, not cold.' },
  ...
  voiceTraits: [
    {
      trait: 'Anti-jargon',
      ex: 'NOT: "leverage algorithmic distribution channels." YES: "Stop renting your audience."',
    },
    {
      trait: 'Reframes the win',
      ex: 'NOT: "1,000 followers." YES: "1,000 fans who drive hours to see you play."',
    },
    {
      trait: 'Confident, not arrogant',
      ex: 'The product speaks for itself. We let the numbers do the bragging.',
    },
    {
      trait: 'Artist-validated',
      ex: 'Built from the artist side means we talk the talk because we walked the walk.',
    },
  ],
...
export const gapDimensions = [
  {
    ...
    future: 'Single clear narrative: "Where Artists and Fans Connect." One story from first listen to superfan.',
  },
  {
    dim: 'Visual Identity',
    priority: 'High',
